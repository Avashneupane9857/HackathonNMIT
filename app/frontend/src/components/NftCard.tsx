          ...
          {nft.isListed ? (
            isOwner ? (
              ...
              <Button
                ...
                className="w-1/2 rounded-lg bg-gradient-to-r from-green-400/80 to-green-600/80 text-black font-bold hover:from-green-300 hover:to-green-500"
              >
