...
// ModalProvider component to wrap the app with the context
...
// Modal component that acts as a wrapper for the modal
export function Modal({ children }: { children: ReactNode }) {
  return <ModalProvider>{children}</ModalProvider>
}

// ModalTrigger button component to trigger opening of the modal
...
// ModalBody component to display the modal content
...
// ModalContent component to display inner modal content
...
// ModalFooter component to display footer buttons
...
// Overlay component to display background
...
// CloseIcon component for closing the modal
const CloseIcon = () => {
  const { setOpen } = useModal()
  return (
